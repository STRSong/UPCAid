...
import jwxt.cacher.cc.jwxt.WelcomeActivity;

/**
 * @author angelo.marchesin
 */
@SuppressWarnings("unused")
public class MyNiceSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int padding=this.getResources().getDimensionPixelOffset(R.dimen.classroom_search_padding);
        linearLayout.setPadding(padding,0,padding,padding);
        linearLayout.setBackgroundResource(R.drawable.classroom_search_pop_backgroung);
...
//        scrollView.addView(listView);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        popupWindow.setHeight(mItemHeight * 4);
...
//                showDropDown();
    ...
    protected void animateArrow(boolean shouldRotateUp) {
